...
fun main() {
    do {
        ...
        var habitat = readlnOrNull()
        if (habitat == "exit") {
            println("See you later!")
            break
        }
        var habitatindex = habitat?.toIntOrNull()

        println(if (habitatindex != null && habitatindex in 0..animals.size) animals[habitatindex] else "There is no habitat with this number.")
        habitatindex = null
    } while(habitatindex == null)
